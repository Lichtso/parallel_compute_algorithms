...
def elementwise(op, parameters, number_of_dimensions=None):
    ...
    parameters : List of element lists, which will be transposed to element tuples
    number_of_dimensions : Nesting level of the element lists
    """
...
def scatter(permutation, elements, condition_flags=None, result_size=None):
    """ Permutation Inverse.
    ...
    The resulting elements not referred to by any index are undefined.
    ----------
    permutation : List of indices
    elements : List of elements
